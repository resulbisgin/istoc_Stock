...
<div class="center">
    ...
    ?>
      <form method="GET" action="inc/edit.php">
     
 
          <div class="txt_field">
            
            <input type="text" name="ad" value="<?php echo $row["urunbaslik"] ;?>" >
            <span></span>
          ...
          <div class="txt_field">
            ...
            <input type="text" name="fiyat"  value="<?php echo $row["urunfiyat"] ;?>" >
            <span></span>
            <label for=""> Ürün Fiyatı</label>
          </div>
          <div class="txt_field">
            
            <input type="text" name="stok" value="<?php echo $row["urunstok"] ;?>"  >
            <span></span>
