...
?>
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Eski Mesajlar  </h1>
     
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><a href="<?php echo admin;?>"><i class="fa fa-home fa-lg"></i></a></li>
         
          <li class="breadcrumb-item active"><a href="#"> Eski Mesajlar Listesi </a></li>
        </ul>
      </div>
      <div class="row">
  <form action="" method="POST" class="col-md-12">
    <div class="form-group">
      <input type="text" class="form-control" placeholder="Kişi Adı ya da   Eposta giriniz" >
    </div>
  </form>
...
<?php 
if($total > $lim){
  pagination($s,ceil($total/$lim),'oldmessage.php?s=');
}
